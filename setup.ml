...
(* OASIS_START *)
(* DO NOT EDIT (digest: 483d837cfd6dc892d987fe5bafdb94d6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mwweissmann/ocaml-posix-clock/";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX clock";
                      doc_authors = [];
                      doc_abstract = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "posix-clock"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\\\132>i\200^D\196\002d\020\018\179\128\000\200";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
